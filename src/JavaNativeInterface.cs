...
namespace org.daisy.jnet
{
    ...
    {
        static public string __jvmDllPath = "";
        static private string __javaVersion = "";
        ...
        public void LoadVM(Dictionary<string, string> options, bool AddToExistingJVM)
        {
            ...
            // TODO : find a way to get the current jre jni support
            /* https://docs.oracle.com/en/java/javase/11/docs/specs/jni/functions.html#interface-function-table
             * 
...
In JDK/JRE 10, GetVersion() returns JNI_VERSION_10.
        ...
        /// TODO : <param name="args">Arguments of the constructor to call</param>
        /// <returns>A pointer to a java object in memory if the constructor could be called without error</returns>
        public IntPtr InstantiateJavaObject(string ClassName, out IntPtr javaClass/*, params object[] args*/)
        {
            ...
            try {
                // TODO reconstruct signatures from an argument list
                IntPtr methodId = env.GetMethodID(javaClass, "<init>", "()V");
                IntPtr javaObject = env.NewObject(javaClass, methodId, new JValue() {});
                // Store for disposal
        ...
        /// <param name="methodName">metho name</param>
        /// <param name="sig">Method JNI signature (see javap -s)</param>
        ...
        public void CallVoidMethod(IntPtr javaClass, IntPtr javaObject, string methodName, string sig, List<object> param)
        {
            try
            {
        ...
        private JValue[] ParseParameters(IntPtr javaClass, string sig, List<object> param)
        {
        ...
        /// <returns></returns>
        public T CallMethod<T>(IntPtr javaClass, IntPtr javaObject, string methodName, string sig, List<object> param)
        {
            IntPtr methodId = env.GetMethodID(javaClass, methodName, sig);
            try
            {
